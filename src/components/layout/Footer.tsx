...
import { Building2, Shield, Lock, CheckCircle, AlertTriangle } from 'lucide-react';
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.key}>
                    <Link
                      to={link.href}
                      className="text-sm text-slate-400 hover:text-blue-400 transition-colors font-light"
                    >
                      {link.key}
                    </Link>
                  </li>
