...
const AdminDashboard = () => {
  ...
  const modules = [
    {
      key: "clients",
      title: t('adminDashboard.modules.clients.title'),
      description: t('adminDashboard.modules.clients.description'),
      icon: Users,
      route: "/admin/control",
      enabled: true,
    },
    ...
    {
      key: "coupons",
      title: t('adminDashboard.modules.coupons.title'),
      description: t('adminDashboard.modules.coupons.description'),
      icon: Ticket,
      route: "/admin/coupons",
      enabled: true,
    },
    {
      key: "twofa",
      title: t('adminDashboard.modules.twofa.title'),
      description: t('adminDashboard.modules.twofa.description'),
      icon: KeyRound,
    ...
    {
      key: "logs",
      title: t('adminDashboard.modules.logs.title'),
      description: t('adminDashboard.modules.logs.description'),
      icon: FileText,
      route: "/admin/logs",
      enabled: true,
    },
    {
      key: "contact",
      title: t('adminDashboard.modules.contact.title'),
      description: t('adminDashboard.modules.contact.description'),
      icon: Mail,
    ...
    {
      key: "downloads",
      title: t('adminDashboard.modules.downloads.title'),
      description: t('adminDashboard.modules.downloads.description'),
      icon: Download,
      enabled: false,
    },
    {
      key: "analytics",
      title: t('adminDashboard.modules.analytics.title'),
      description: t('adminDashboard.modules.analytics.description'),
      icon: BarChart3,
      enabled: false,
    },
    {
