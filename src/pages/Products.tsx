...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900/95 to-slate-950/98 backdrop-blur-sm">
      <PageSEO
        title="Documentation"
        description="Professional product documentation: rental plans, legal policies, system status, and getting started guides."
      ...
      <section className="relative py-32 px-4 bg-gradient-to-br from-slate-900/95 via-slate-900/90 to-slate-950/98 backdrop-blur-sm">
        <div className="container mx-auto text-center max-w-5xl">
          ...
          <h1 className="text-5xl md:text-6xl font-light text-slate-100 mb-6 leading-[1.15] tracking-tight">
            Documentation & Policies
          </h1>
          <p className="text-xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
            Professional documentation for AInside.me software: rental plans overview, legal policies, system status, and getting started guides. Educational tools only — no financial advice.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Link to="/pricing" className="text-center group hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-light text-slate-100 mb-2">Rental Plans</h3>
              <p className="text-slate-300 text-sm font-light">Overview of Micro/Mini contracts and billing options.</p>
            </Link>
            <Link to="/contact" className="text-center group hover:scale-105 transition-transform duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <FileText className="w-8 h-8 text-blue-400" />
              </div>
              <h3 className="text-xl font-light text-slate-100 mb-2">Contact Support</h3>
              <p className="text-slate-300 text-sm font-light">Get assistance from our support team.</p>
            </Link>
            <Link to="/legal/terms" className="text-center group hover:scale-105 transition-transform duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <Book className="w-8 h-8 text-blue-400" />
              </div>
              <h3 className="text-xl font-light text-slate-100 mb-2">Terms & Conditions</h3>
              <p className="text-slate-300 text-sm font-light">Educational use only — software provided “AS IS”.</p>
            </Link>
            <Link to="/legal/privacy" className="text-center group hover:scale-105 transition-transform duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <Shield className="w-8 h-8 text-blue-400" />
              </div>
              <h3 className="text-xl font-light text-slate-100 mb-2">Privacy Policy</h3>
              <p className="text-slate-300 text-sm font-light">Minimal technical data only. No financial data stored.</p>
            </Link>
            <Link to="/status" className="text-center group hover:scale-105 transition-transform duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <Info className="w-8 h-8 text-blue-400" />
              </div>
              <h3 className="text-xl font-light text-slate-100 mb-2">System Status</h3>
              <p className="text-slate-300 text-sm font-light">Current operational status for platform components.</p>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-gradient-to-br from-slate-950/95 via-slate-900/90 to-slate-950/98 backdrop-blur-sm border-t border-slate-700/30">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <p className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto leading-relaxed font-light">
            Watch our proprietary algorithms analyze live market data in real-time with advanced technical indicators
          </p>
