            ...
            <Card className="w-full bg-slate-800/40 border-slate-700/50 backdrop-blur-sm">
              ...
              <CardContent>
                <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
                  <TabsList className="grid w-full grid-cols-3 mb-8 bg-slate-900/50 border border-slate-700/50">
                    <TabsTrigger value="gainers" className="flex items-center gap-2 data-[state=active]:bg-slate-700/50 data-[state=active]:text-blue-400">
                      <TrendingUp className="w-4 h-4" />
                      Top Gainers
                    </TabsTrigger>
                    <TabsTrigger value="losers" className="flex items-center gap-2 data-[state=active]:bg-slate-700/50 data-[state=active]:text-blue-400">
                      <ArrowDownRight className="w-4 h-4" />
                      Top Losers
                    </TabsTrigger>
                    <TabsTrigger value="volume" className="flex items-center gap-2 data-[state=active]:bg-slate-700/50 data-[state=active]:text-blue-400">
                      <BarChart3 className="w-4 h-4" />
                      Volume Spikes
                    </TabsTrigger>
                  </TabsList>
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="border-b border-slate-700/50">
                            <th className="text-left py-4 px-4 font-medium text-slate-400 text-sm">Symbol</th>
                            <th className="text-right py-4 px-4 font-medium text-slate-400 text-sm">Price</th>
                            <th className="text-right py-4 px-4 font-medium text-slate-400 text-sm">24h Change</th>
                            <th className="text-right py-4 px-4 font-medium text-slate-400 text-sm">Volume 24h</th>
                            <th className="text-right py-4 px-4 font-medium text-slate-400 text-sm">Volume Change</th>
                            <th className="text-center py-4 px-4 font-medium text-slate-400 text-sm">Strength</th>
                            <th className="text-center py-4 px-4 font-medium text-slate-400 text-sm">Score</th>
                            <th className="text-center py-4 px-4 font-medium text-slate-400 text-sm">Indicator</th>
                            <th className="text-right py-4 px-4 font-medium text-slate-400 text-sm">ATR%</th>
                            <th className="text-center py-4 px-4 font-medium text-slate-400 text-sm">Action</th>
                          </tr>
                        </thead>
                        <tbody>
                          {isLoading ? (
                              ...
                              <tr key={index} className="border-b border-slate-800/50 hover:bg-slate-800/30 transition-colors">
                                <td className="py-4 px-4">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <span className="font-medium text-slate-200">{crypto.symbol}</span>
                                  </div>
                                </td>
                                <td className="text-right py-4 px-4 font-mono text-slate-200">
                                ...
                                <td className="text-right py-4 px-4 font-mono text-slate-300">
                                ...
                                <td className="text-center py-4 px-4">
                                  <div className="flex items-center justify-center gap-2">
                                    ...
                                    <span className="text-sm text-slate-400">{crypto.strength}%</span>
                                  </div>
                                </td>
                                <td className="text-center py-4 px-4">
                                  <Badge
