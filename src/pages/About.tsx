  ...
  const leadership = [
    {
      ...
      description: "Decades of combined experience in financial technology and institutional services"
    },
    {
      name: "Technology Team", 
      role: "Innovation & Development",
      description: "Expert engineers and analysts dedicated to advancing financial technology solutions"
    },
    {
      name: "Operations Team",
      role: "Service Excellence", 
      description: "Committed professionals ensuring reliable delivery and client satisfaction"
    }
  ];
  ...
  const milestones = [
    {
      icon: Building2,
      title: "Founded",
      description: "Established to provide institutional-grade technology solutions"
    },
    {
      icon: Zap,
      title: "Innovation",
      description: "Continuous advancement in analytical technology and infrastructure"
    },
    {
      icon: Globe,
      title: "Global Reach",
      description: "Serving financial institutions across multiple markets"
    },
    {
      icon: Award,
      title: "Recognition",
      description: "Trusted by leading institutions for technology excellence"
    }
  ];
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="text-center group hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-light text-slate-100 mb-3 group-hover:text-blue-200 transition-colors duration-300">Integrity</h3>
              <p className="text-slate-300 leading-relaxed text-sm font-light group-hover:text-slate-200 transition-colors duration-300">
            ...
            <div className="text-center group hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-light text-slate-100 mb-3 group-hover:text-cyan-200 transition-colors duration-300">Innovation</h3>
              <p className="text-slate-300 leading-relaxed text-sm font-light group-hover:text-slate-200 transition-colors duration-300">
                Continuously advancing technology to meet evolving industry needs
              </p>
            </div>
            ...
            <div className="text-center group hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-light text-slate-100 mb-3 group-hover:text-emerald-200 transition-colors duration-300">Excellence</h3>
              <p className="text-slate-300 leading-relaxed text-sm font-light group-hover:text-slate-200 transition-colors duration-300">
                Delivering superior quality in every aspect of our services and solutions
              </p>
            </div>
            ...
            <div className="text-center group hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="text-xl font-light text-slate-100 mb-3 group-hover:text-purple-200 transition-colors duration-300">Partnership</h3>
              <p className="text-slate-300 leading-relaxed text-sm font-light group-hover:text-slate-200 transition-colors duration-300">
                Building lasting relationships through trust, collaboration, and shared success
              </p>
            </div>
          </div>
        </div>
