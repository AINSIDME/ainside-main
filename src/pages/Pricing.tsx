        ...
        <div className="max-w-5xl mx-auto grid gap-6 md:grid-cols-2 auto-rows-fr">
          ...
          <Card className="h-full flex flex-col justify-between rounded-xl border border-slate-800 bg-slate-950">
            ...
            <CardFooter className="mt-auto">
              ...
              >
                {t("pricing.cta", { defaultValue: "Suscribirme" })} • {t("pricing.micro.short", { defaultValue: "Micro" })} •{" "}
                {currentInstrument.name} • {billing === "monthly" ? t("pricing.monthlyShort", { defaultValue: "Mensual" }) : t("pricing.annualShort", { defaultValue: "Anual" })}
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="h-full flex flex-col justify-between rounded-xl border border-slate-800 bg-slate-950">
            ...
            <CardFooter className="mt-auto">
              ...
              >
                {t("pricing.cta", { defaultValue: "Suscribirme" })} • {t("pricing.mini.short", { defaultValue: "Mini" })} •{" "}
                {currentInstrument.name} • {billing === "monthly" ? t("pricing.monthlyShort", { defaultValue: "Mensual" }) : t("pricing.annualShort", { defaultValue: "Anual" })}
              </Button>
            </CardFooter>
          </Card>
